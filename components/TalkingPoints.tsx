  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2 tracking-tight">Talking Points</h2>
        <p className="text-gray-700 mb-6 font-medium">Helpful advocacy statements for your appointments</p>
